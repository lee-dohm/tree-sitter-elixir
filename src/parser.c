...
enum {
  ...
  sym_map = 24,
  sym_tuple = 25,
  sym__keyword_list_entry = 26,
  sym_list = 27,
  sym__reserved_literal = 28,
  aux_sym_file_repeat1 = 29,
  aux_sym_map_repeat1 = 30,
  aux_sym_tuple_repeat1 = 31,
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(13),
  [23] = {.count = 1, .reusable = true, .depends_on_lookahead = true}, SHIFT(14),
  [25] = {.count = 1, .reusable = true, .depends_on_lookahead = false}, SHIFT(17),
